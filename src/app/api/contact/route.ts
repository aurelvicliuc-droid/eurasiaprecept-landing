          ...
          <div style="background: #f7f6f4; padding: 32px; border: 1px solid #cccbc2; border-top: none; border-radius: 0 0 8px 8px;">
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
              <tr>
                ...
                <td style="padding: 8px 0; font-size: 15px; color: #3D3C3C;">${name}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style="padding: 8px 0; font-size: 15px; color: #3D3C3C;">${subject}</td>
              </tr>` : ''}
            </table>
            <div style="border-top: 1px solid #cccbc2; padding-top: 20px;">
              ...
              <p style="font-size: 15px; line-height: 1.7; color: #3D3C3C; white-space: pre-line; margin: 0;">${message}</p>
            </div>
          </div>
