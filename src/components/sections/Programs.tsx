              ...
              <div key={group.cat} className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                  {group.items.map((prog, i) => (
                    <motion.article
                      key={prog.id}
                      className={`bg-cream rounded-xl p-6 flex flex-col border transition-all duration-200 cursor-default
                        ${prog.featured
                          ? 'border-teal border-[1.5px]'
                          : 'border-beige-dark hover:border-teal/40'
                        } hover:shadow-[0_8px_24px_rgba(26,58,42,0.1)] hover:-translate-y-[2px]`}
                    ...
                    >
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-[12px] font-semibold tracking-[0.08em] uppercase
                          text-teal hover:text-green-dark transition-colors duration-200 group"
                      >
                        Detalii complete
                        <ArrowRight
                          size={13}
