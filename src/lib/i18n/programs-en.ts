...
export const programsEn: Record<string, ProgramTranslation> = {
  ...
  'nivelul-3-4': {
    ...
    curriculum: [
      ...
      { title: 'Time Management', manual: '1 Thessalonians' },
      { title: 'Church Growth', manual: 'Ephesians' },
      { title: 'The Servant of God', manual: 'The Gospel of Mark' },
      { title: 'Lord, Have Mercy on Your People', manual: 'Joel, Obadiah' },
      { title: 'Understanding the Wrath of God', manual: 'Habakkuk, Nahum and Micah' },
      { title: 'Counseling', manual: 'Lord, Heal My Hurts' },
      { title: 'Life in Christ', manual: 'Colossians' },
      { title: 'Understanding the Lord\'s Promises', manuals: [
        { title: 'Malachi' },
        { title: 'Zechariah' },
      ] },
      { title: 'The Blessings of Obedience and the Consequences of Disobedience', manual: 'Judges' },
      { title: 'Spiritual Counseling', manual: 'Spiritual Warfare' },
      { title: 'Church History – I', manual: 'Acts of the Apostles (Part I)' },
      { title: 'Church History – II', manual: 'Acts of the Apostles (Part II)' },
      { title: 'How to Know You Have Eternal Life', manual: '1, 2 & 3 John' },
      { title: 'Anatomy of an Apostle', manual: '2 Corinthians' },
      { title: 'Prophecies Before the Fall of Jerusalem', manual: 'Jeremiah (Part I)' },
      { title: 'Prophecies Concerning the Nations', manual: 'Jeremiah (Part II)' },
      { title: 'Understanding Grace', manual: 'Galatians' },
      { title: 'Spiritual Counseling', manual: 'Job' },
      { title: 'The Book of Ezekiel (Part I)', manual: 'Ezekiel (Part I)' },
      { title: 'The Book of Ezekiel (Part II)', manual: 'Ezekiel (Part II)' },
      { title: 'Living in Holiness', manual: 'Leviticus' },
      { title: 'How to Stand Firm When Tested', manual: '1 Peter' },
      { title: 'Suffering and Glory', manual: '2 Peter' },
      { title: 'Leadership Principles', manual: 'Ezra and Haggai' },
      { title: 'Courage for Such a Time as This', manual: 'Esther' },
      { title: 'Leadership Principles', manual: 'Nehemiah' },
      { title: 'Contending for the Faith', manual: 'Jude' },
      { title: 'Jesus Christ, the Perfect Man', manual: 'Luke (Part I)' },
      { title: 'The Savior of Sinners', manual: 'Luke (Part II)' },
      { title: 'Counseling', manual: 'Lord, Help Me Choose You' },
      { title: 'Revival or Bondage', manual: '1 Kings and 2 Chronicles' },
      { title: 'Discipline in the Church', manual: '1 Timothy' },
      { title: 'Leadership Principles', manual: 'Numbers' },
      { title: 'The Foundations of Evangelism', manual: 'The Gospel of Matthew (Part I)' },
      { title: 'Who Is Jesus? The Christ, the Son of the Living God', manual: 'The Gospel of Matthew (Part II)' },
    ],
    structure: [],
    outcomes: [
