  ...
  ro: {
    ...
    about: {
      ...
      team: {
        ...
        members: [
          { initials: 'JK', name: 'Jack și Kay Arthur', role: 'Fondatori Precept Ministries International', photo: '/team/jack-kay.jpg' },
  ...
  en: {
    ...
    about: {
      ...
      team: {
        ...
        members: [
          { initials: 'JK', name: 'Jack & Kay Arthur', role: 'Founders, Precept Ministries International', photo: '/team/jack-kay.jpg' },
  ...
  ru: {
    ...
    about: {
      ...
      team: {
        ...
        members: [
          { initials: 'JK', name: 'Джек и Кей Артур', role: 'Основатели Precept Ministries International', photo: '/team/jack-kay.jpg' },
