...
export const programs: ProgramData[] = [
  ...
  },
  {
    ...
    curriculum: [
      ...
      { title: 'Planificarea Timpului', manual: '1 Tesaloniceni', manualHref: 'https://shop.eurasiaprecept.org/catalog/1-tesaloniceni' },
      { title: 'Creșterea Bisericii', manual: 'Efeseni', manualHref: 'https://shop.eurasiaprecept.org/catalog/efeseni' },
      { title: 'Slujitorul lui Dumnezeu', manual: 'Evanghelia după Marcu', manualHref: 'https://shop.eurasiaprecept.org/catalog/evanghelia-dupa-marcu' },
      { title: 'Doamne, îndură-Te de poporul Tău', manual: 'Ioel, Obadia', manualHref: 'https://shop.eurasiaprecept.org/catalog/doamne-indura-te-de-poporul-tau' },
      { title: 'Înțelegerea mâniei lui Dumnezeu', manual: 'Habacuc, Naum și Mica', manualHref: 'https://shop.eurasiaprecept.org/catalog/intelegerea-maniei-lui-dumnezeu' },
      { title: 'Consiliere', manual: 'Doamne, vindecă-mi rănile', manualHref: 'https://shop.eurasiaprecept.org/catalog/doamne-vindeca-mi-ranile' },
      { title: 'Viața în Hristos', manual: 'Coloseni', manualHref: 'https://shop.eurasiaprecept.org/catalog/coloseni' },
      ...
      { title: 'Binecuvântările ascultării și consecințele neascultării', manual: 'Judecătorii', manualHref: 'https://shop.eurasiaprecept.org/catalog/judecatori' },
      { title: 'Consiliere spirituală', manual: 'Lupta spirituală', manualHref: 'https://shop.eurasiaprecept.org/catalog/doamne-invata-ma-sa-fiu-biruitor-in-lupta-spirituala' },
      { title: 'Istoria Bisericii – I', manual: 'Faptele Apostolilor (partea I)', manualHref: 'https://shop.eurasiaprecept.org/catalog/faptele-apostolilor-partea-1' },
      { title: 'Istoria Bisericii – II', manual: 'Faptele Apostolilor (partea II)', manualHref: 'https://shop.eurasiaprecept.org/catalog/faptele-apostolilor-partea-ii-a' },
      { title: 'Cum știi că ai viață veșnică', manual: '1, 2 și 3 Ioan', manualHref: 'https://shop.eurasiaprecept.org/catalog/12-si-3-ioan' },
      { title: 'Anatomia unui apostol', manual: '2 Corinteni', manualHref: 'https://shop.eurasiaprecept.org/catalog/2-corinteni' },
      { title: 'Profeții înainte de căderea Ierusalimului', manual: 'Ieremia (partea I)', manualHref: 'https://shop.eurasiaprecept.org/catalog/ieremia-partea-1' },
      { title: 'Profeții cu privire la neamuri', manual: 'Ieremia (partea II)', manualHref: 'https://shop.eurasiaprecept.org/catalog/ieremia-partea-2' },
      { title: 'Înțelegerea harului', manual: 'Galateni', manualHref: 'https://shop.eurasiaprecept.org/catalog/galateni' },
      { title: 'Consiliere spirituală', manual: 'Iov', manualHref: 'https://shop.eurasiaprecept.org/catalog/iov' },
      { title: 'Cartea lui Ezechiel (partea I)', manual: 'Ezechiel (partea I)', manualHref: 'https://shop.eurasiaprecept.org/catalog/ezechiel-partea-1' },
      { title: 'Cartea lui Ezechiel (partea II)', manual: 'Ezechiel (partea II)', manualHref: 'https://shop.eurasiaprecept.org/catalog/ezechiel-partea-2' },
      { title: 'Trăirea în sfințenie', manual: 'Levitic', manualHref: 'https://shop.eurasiaprecept.org/catalog/leviticul' },
      { title: 'Cum să rămâi tare când ești încercat', manual: '1 Petru', manualHref: 'https://shop.eurasiaprecept.org/catalog/1-petru' },
      { title: 'Suferință și slavă', manual: '2 Petru', manualHref: 'https://shop.eurasiaprecept.org/catalog/2-petru' },
      { title: 'Principii de lideri', manual: 'Ezra și Hagai', manualHref: 'https://shop.eurasiaprecept.org/catalog/ezra-si-hagai' },
      { title: 'Curaj pentru o vreme ca aceasta', manual: 'Estera', manualHref: 'https://shop.eurasiaprecept.org/catalog/estera' },
      { title: 'Principii de lideri', manual: 'Neemia', manualHref: 'https://shop.eurasiaprecept.org/catalog/neemia' },
      { title: 'Lupta pentru credință', manual: 'Iuda', manualHref: 'https://shop.eurasiaprecept.org/catalog/iuda' },
      { title: 'Isus Hristos, omul desăvârșit', manual: 'Luca (partea I)', manualHref: 'https://shop.eurasiaprecept.org/catalog/evanghelia-dupa-luca-partea-i' },
      { title: 'Mântuitorul păcătoșilor', manual: 'Luca (partea II)', manualHref: 'https://shop.eurasiaprecept.org/catalog/evanghelia-dupa-luca-partea-ii' },
      { title: 'Consiliere', manual: 'Doamne, ajută-mă să Te aleg', manualHref: 'https://shop.eurasiaprecept.org/catalog/doamne-ajuta-ma-sa-te-aleg' },
      { title: 'Trezire sau robie', manual: '1 Împărați și 2 Cronici', manualHref: 'https://shop.eurasiaprecept.org/catalog/o-inima-impartita-o-natiune-impartita' },
      { title: 'Disciplina în biserică', manual: '1 Timotei' },
      { title: 'Principii de lideri', manual: 'Numeri', manualHref: 'https://shop.eurasiaprecept.org/catalog/numeri' },
      { title: 'Bazele evanghelizării', manual: 'Evanghelia după Matei (partea I)', manualHref: 'https://shop.eurasiaprecept.org/catalog/evanghelia-dupa-matei-partea-1' },
      { title: 'Cine este Isus? Hristos, Fiul Dumnezeului celui Viu', manual: 'Evanghelia după Matei (partea II)', manualHref: 'https://shop.eurasiaprecept.org/catalog/evanghelia-dupa-matei-partea-2' },
    ],
    structure: [],
    outcomes: [
